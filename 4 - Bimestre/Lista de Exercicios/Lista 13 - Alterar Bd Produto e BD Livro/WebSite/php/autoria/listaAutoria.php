    ...
    <main class="table">
        ...
        <section class="table__body">
            <table>
                <thead>
                    <tr>
                        <th> Cod_Autoria <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Cod_Autor <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Cod_Livro <span class="icon-arrow">&UpArrow;</span></th>
                        <th> DataLancamento <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Editora <span class="icon-arrow">&UpArrow;</span></th>
                    </tr> 
                </thead>
                <tbody>
                    <?php 
