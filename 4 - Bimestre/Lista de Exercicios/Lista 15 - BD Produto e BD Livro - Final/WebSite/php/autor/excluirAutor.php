...
<head>
    ...
    <title>Tela De Excluir Autor</title>
</head>
<style>
...
<body>
    <section>
        ...
        <div class="box">
            ...
            <div class="container">
                <div class="form">
                    <h2>Tela de Excluir do Autor</h2>
                    <form name="cliente" method = "POST" action = "">
                        <div class="inputbox">
                            <p> Código Autor </p><input name="txtid" type="text" size="40" placeholder="Digite o Código Autor" required onkeypress="return blokletras(window.event.keyCode)"></p>               
                        </div>
                        <div class="inputbox">
