...
<body>
    <section>
        ...
        <div class="box">
            ...
            <div class="container">
                <div class="form">
                    <h2>Tela de Alterar Do Produto</h2>
                        <div class="inputbox">
                        ...
                        <?php
                            ...
                            ?>  
                            <div class="inputbox">
                                <input type="hidden" name="txtid" class="white"  size="5" value='<?php echo $pro_mostrar[0]?>'>
                                <?php echo "<h3 class='white'>ID: " .  $pro_mostrar[0] ."</h3>"; ?>  
                            </div>
                            <div class="inputbox">
                                <?php echo "<h3 class='white'>Nome" .  "</h3>";?>
                                <input name="txtnome" type="text" size="25" value='<?php echo $pro_mostrar[1]?>' required>
                            </div>
                            <div class="inputbox">
                                <?php echo "<h3 class='white'>Estoque" .  "</h3>";?>
                                <input name="txtestoq" type="text" size="10" value='<?php echo $pro_mostrar[2]?>' required onkeypress="return blokletras(window.event.keyCode)" >
                                <br><br>  
...
function Contagem() {
    ...
    if (segundosRestantes > 0) {
        ...
        window.location.href='Pri_alterarProduto.php';
    }
}
