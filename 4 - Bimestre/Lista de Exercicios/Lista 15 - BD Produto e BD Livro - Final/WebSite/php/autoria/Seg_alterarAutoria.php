                    ...
                    <h2>Tela de Alterar Do Autoria</h2>
                        ...
                        <?php
                            ...
                            <div class="inputbox">
                                ...
                                <input type="text" name="txtCod_Autor" class="white"  size="5" value='<?php echo $pro_mostrar[1]?>' required onkeypress="return blokletras(window.event.keyCode)">          
                            </div> 
                            <div class="inputbox">
                                <?php echo "<h3 class='white'>Cod_Livro: " .  $pro_mostrar[2] ."</h3>"; ?>  
                                <input type="text" name="txtCod_Livro" class="white"  size="5" value='<?php echo $pro_mostrar[2]?>' required onkeypress="return blokletras(window.event.keyCode)">
                            </div> 
                            <div class="inputbox">
                             <?php echo "<h3 class='white'>Data de Lancamento: "; ?> 
                               <input name="txtDataLancamento" type="date" size="40" value='<?php echo $pro_mostrar[3]?>'>
                            </div>
                            <div class="inputbox">
