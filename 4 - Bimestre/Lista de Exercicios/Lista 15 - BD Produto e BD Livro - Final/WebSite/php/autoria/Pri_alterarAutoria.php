        ...
        <div class="box">
            ...
            <div class="container">
                <div class="form">
                    ...
                    <form name="cliente" method = "POST" action = "Seg_alterarAutoria.php">
                        <div class="inputbox">
                            <p> Código do Autoria: </p><input name="txtCod_Autoria" type="text" size="40" placeholder="Digite o Código-Autoria" required onkeypress="return blokletras(window.event.keyCode)"></p>               
                        </div>
                        <div class="inputbox">
