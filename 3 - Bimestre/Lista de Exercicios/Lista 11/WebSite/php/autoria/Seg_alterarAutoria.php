                    ...
                    <h2>Tela de Alterar Do Autoria</h2>
                        ...
                        <?php
                            ...
                            <b> <?php echo "ID: "; // Como é matriz - posição 0 ?></b>   
                               <input name="txtCod_Autoria" type="text" size="40" value='<?php echo $pro_mostrar[0]?>'>
                            </div>
                            <div class="inputbox">
                                <b> <?php echo "Cod_Autor: ";?></b> 
                                <input name="txtCod_Autor" type="text" size="40" value='<?php echo $pro_mostrar[1]?>'>
                            </div>

                            <div class="inputbox">
                            <b> <?php echo "Cod_Livro: "; // Como é matriz - posição 0 ?></b>   
                               <input name="txtCod_Livro" type="text" size="40" value='<?php echo $pro_mostrar[2]?>'>
                            </div>
                            <div class="inputbox">
                                <b> <?php echo "DataLancamento: ";?></b> 
                                <input name="txtDataLancamento" type="text" size="40" value='<?php echo $pro_mostrar[3]?>'>
                            </div>

                            <div class="inputbox">
                            <b> <?php echo "Editora: "; // Como é matriz - posição 0 ?></b>   
